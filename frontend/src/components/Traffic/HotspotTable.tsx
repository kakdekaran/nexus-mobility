...
const HotspotTable: React.FC<HotspotTableProps> = ({ data: apiData }) => {
  const [exporting, setExporting] = useState(false);
  const [focused, setFocused] = useState<string | null>(null);
  const [sortConfig, setSortConfig] = useState<{ key: string, direction: 'asc' | 'desc' }>({ key: 'congestion', direction: 'desc' });
