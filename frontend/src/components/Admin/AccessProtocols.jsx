    ...
    <div className="bg-surface-container rounded-xl p-6 relative overflow-hidden group shadow-lg border border-slate-800/50 font-body">
      ...
      <div className="mt-6 flex items-center gap-4">
        <div className="flex -space-x-2">
          ...
          <div className="w-8 h-8 rounded-full border-2 border-slate-900 bg-surface-container-high flex items-center justify-center text-[8px] font-black text-on-surface-variant">+4</div>
        </div>
        <p className="text-[10px] text-on-surface-variant font-black uppercase tracking-widest">Other root admins online</p>
      </div>
    </div>
  );
};
