  ...
  return (
    <div className="col-span-12 lg:col-span-4 space-y-8 font-body">
      ...
      <motion.div 
        ...
        className="bg-white/[0.03] backdrop-blur-md rounded-[2.5rem] overflow-hidden h-[320px] relative group cursor-pointer shadow-2xl border border-on-surface/5"
      >
        <img 
        ...
        <div className="space-y-4">
          {sensors.map((sensor, i) => (
            <motion.div 
              key={i} 
              whileHover={{ x: 5 }}
              className="bg-white/[0.02] p-5 rounded-2xl flex items-center justify-between hover:bg-white/[0.05] transition-all group border border-on-surface/5 shadow-sm"
            >
