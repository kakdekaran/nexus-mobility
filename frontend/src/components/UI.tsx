...
export const LoadingSpinner = ({ label = 'Loading data...' }: { label?: string }) => {
...
export const EmptyState = ({ message = 'No records found for this selection' }: { message?: string }) => {
  const { theme } = useTheme();
  return (
    <motion.div 
...
export const GlassCard = ({ children, style = {}, padding = '1.5rem' }: { children: React.ReactNode, style?: React.CSSProperties, padding?: string }) => {
  const { theme } = useTheme();
  return (
    <div style={{
