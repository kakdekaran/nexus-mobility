  ...
  return (
    <div className="p-8 max-w-6xl mx-auto font-body min-h-screen">
      <header className="mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-3xl font-black text-on-surface uppercase tracking-tighter antialiased">Command Inbox</h1>
        ...
        <div className="flex bg-surface-container/50 p-1 rounded-xl border border-on-surface/5 backdrop-blur-md">
            ...
            <motion.div
              ...
              className={`p-5 rounded-2xl border cursor-pointer transition-all ${
                selectedNotif?.id === notif.id 
                  ...
                  : 'bg-on-surface/5 border-on-surface/5 hover:bg-on-surface/10'
              } relative group`}
            >
            ...
            {selectedNotif ? (
              ...
              >
                <GlassCard className="h-full p-8 flex flex-col items-start relative overflow-hidden group">
                  ...
                  <h2 className="text-2xl font-black text-on-surface uppercase tracking-tighter mb-4 leading-tight relative z-10">
                    {selectedNotif.title}
                  </h2>
                  
                  <div className="flex items-center gap-4 mb-8 p-3 bg-on-surface/5 rounded-2xl w-full border border-on-surface/5 relative z-10">
                    <div className="w-10 h-10 rounded-full bg-surface-container-high flex items-center justify-center border border-on-surface/10 shrink-0">
                  ...
                  <div className="w-full pt-6 mt-auto border-t border-on-surface/5 flex gap-3 relative z-10">
                    <button className="flex-1 bg-on-surface/5 hover:bg-on-surface/10 text-on-surface font-black text-[9px] uppercase tracking-widest py-3 rounded-xl transition-all border border-on-surface/5 flex items-center justify-center gap-2">
                      <span className="material-symbols-outlined text-sm">print</span>
                      Export
                    </button>
                    <button className="flex-1 bg-primary hover:bg-primary/90 text-on-surface font-black text-[9px] uppercase tracking-widest py-3 rounded-xl shadow-lg shadow-primary/20 transition-all active:scale-95 flex items-center justify-center gap-2 px-4">
